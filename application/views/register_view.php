...
<input type="submit" value="Sign up" name="register"/>
    ...
    <p>
        ...
        require_once 'C:/xampp/htdocs/trial/facebook-php-sdk-v4-5.0.0/facebook-php-sdk-v4-5.0.0/src/Facebook/autoload.php';
	
        #require_once dirname(__FILE__) . '\facebook-php-sdk-v4-5.0.0\facebook-php-sdk-v4-5.0.0\src\Facebook\autoload.php';
        $fb = new Facebook\Facebook([
        'app_id' => '788048804656943',
        'app_secret' => '0c4d9a8226fdf5540b6c6c94c0fa1a67',
      ...
      $loginUrl = $helper->getLoginUrl(site_url('user/try1a'), $permissions);
